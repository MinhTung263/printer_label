...
class PrintLabel: FlutterActivity() {
    ...
    public fun connectNet(ipAddress: String) {
        curConnect?.close()
...
//            }
//    }
    public fun printBarcode(call: MethodCall,result: MethodChannel.Result) {
    ...
    public fun printImage(call: MethodCall){
        val printer = TSPLPrinter(curConnect)
